...
useEffect(() => {
  ...
  const file =
    lectureVideo instanceof File
      ? lectureVideo
      : lectureVideo[0] instanceof File
      ? lectureVideo[0]
      : null;
  ...
  video.onloadedmetadata = () => {
    const durationInSeconds = Math.max(1, Math.ceil(video.duration));
...
useEffect(() => {
  if (edit && modalData?.timeDuration) {
    setVideoDuration(modalData.timeDuration);
  }
}, [edit, modalData]);
